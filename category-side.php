            ...
            <main class="l-main">
                <section class="p-archive__main-visual">
                    <div class="main-visual__img">
                        <img class="main-visual__img--sp" src="<?php echo esc_url(get_theme_file_uri( '/images/cooked-foods-750073-2.jpg' ) ); ?>" alt="メインビジュアル スマホ">
                    </div>
                    <div class="main-visual__title">
                        <h1 class="c-heading--roboto">Menu:</h1>
                        <p class="c-heading--notosans"><?php echo esc_html__( 'Side', 'raisetech-hamburger_wp' ); ?></p>
                    </div>
                </section>
